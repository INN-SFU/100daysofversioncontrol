...
This is the central station for tracking progress on the 100 days of version control challenge. We want to use a repository because that's the most transparent way of doing it, and because you can get a few points just by contributing here 😂
...
![](https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExaTYwNjR4bmN4aXF4MjB4NmEzNDQweXplMm1tcngyMGsyM3hwbmV2YyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/e9naycep2pz7OHQ4n0/giphy.gif)
...
1. Create a branch from the main branch and name it CHANGELOG/YourName.
2. Edit the CHANGELOG.md file. This is a simple text file that you can edit using a plain text editor. There, log your contribution following the example in the file, describing what you did and linking the relevant contribution (a commit, a PR, an issue, etc.)
...
![](https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExeGlvc25qcDg5ZHE4ODNreDd1M2h4Z3YxbGpyM2tiYzBodHYyNzkzYiZlcD12MV9naWZzX3NlYXJjaCZjdD1n/Y2LBRcUfNMxzqQpwiq/giphy.gif)
